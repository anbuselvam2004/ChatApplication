            ...
            <div className='rounded-xl  border border-base-300 overflow-hidden bg-base-100 shadow-lg'>
              <div className='p-4 bg-base-200'>
                    <div className='max-w-lg mx-auto'>
                        <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden flex flex-col h-[500px]'>
                            ...
                            <div className='p-4 space-y-4 min-h-[300px] max-h-[200px] overflow-auto bg-base-100'>
                              {
